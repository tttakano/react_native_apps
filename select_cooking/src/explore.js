...
export default class explore extends Component {
    ...
    //urlからHTMLを取得、正規表現を使って必要なものを取り出し、検索結果の中からランダムなurlを返す関数
    geturl(){
        var myRE=/\/recipe\/\d+/g;
        var serch=null;
        (this.props.purpose)?
            serch="https://cookpad.com/search/"+this.props.product+"  "+this.props.purpose+"?purpose="+this.props.purpose
        :
            serch="https://cookpad.com/search/"+this.props.product
        fetch(serch)
            .then(res => res.text())
